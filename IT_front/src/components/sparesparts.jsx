...
import {  spareParts } from "./schemas/schema";
...
const Spareparts = () => {
    ...
    const { values, handleChange, handleBlur, handleSubmit, errors, touched, isValid } = useFormik({
        ...
        onSubmit: async (values, actions) => {
            ...
            console.log(values)
            await axios.post("http://localhost:5137/api/SpareParts", values).then( res => {
                toast.success("تم اضافة القطعه بنجاح")
                actions.resetForm()
            }
        ...
        <div className='m-cont ' >
            <div className="w-90 p-1 border-0 rounded-4 ">
                ...
                <form onSubmit={isValid ? handleSubmit : handleError} className='form' >
                    <div className="my-container bg-gray pt-0 pb-5  mb-4 t-3  m-loc">

                        {/* <modal open = {openModal}/> */}

                        <h2 className='mt-5  '>قطع الغيار  </h2>
                        ...
                        <div className="row  mt-2 ">
                            ...
                            <div className="col">
                                <span className='mylabel'>
                                    <label className='' htmlFor='name' name='name'> اسم القطعه   </label>
                                </span>
